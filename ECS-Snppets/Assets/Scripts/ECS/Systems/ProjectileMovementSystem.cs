...
namespace ECS
{
    ...
    //{
    //    [BurstCompile]
    //    struct ProjectileMoveJob : IJobProcessComponentData <Projectile, Position3D, Rotation>
    //    {
    //        // define public variables to get from outside (e.g. deltaTime
    //        public float deltaTime;

    //        public void Execute([ReadOnly]ref Projectile proj, ref Position3D pos, [ReadOnly]ref Rotation rot)
    //        {
